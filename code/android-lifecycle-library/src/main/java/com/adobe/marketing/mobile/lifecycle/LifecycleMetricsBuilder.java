...
final class LifecycleMetricsBuilder {
    ...
    LifecycleMetricsBuilder addGenericData() {
        Log.trace(LifecycleConstants.LOG_TAG, SELF_LOG_TAG, new HashMap<String, Object>() {{
            put("operation", "add generic data");
    ...
    LifecycleMetricsBuilder addCoreData() {
        Log.trace(LifecycleConstants.LOG_TAG, SELF_LOG_TAG, new HashMap<String, Object>() {{
            put("operation", "add core data");
        }}, "Adding core data to lifecycle data map");
