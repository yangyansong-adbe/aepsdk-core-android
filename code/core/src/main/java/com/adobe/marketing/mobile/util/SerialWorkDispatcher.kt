...
import com.adobe.marketing.mobile.internal.util.createSingleThreadFactory
...
open class SerialWorkDispatcher<T>(private val name: String, private val workHandler: WorkHandler<T>) {
     ...
     */
    private var executorService: ExecutorService = Executors.newSingleThreadExecutor(createSingleThreadFactory(name))
